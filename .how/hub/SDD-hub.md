...
| LC-19 | gateway | Rundown Parser Profiles CRUD (retired per SPEC-70; historical: `09-rundown-parser-profiles.md`, FR-36) |
...
| `/api/admin/parser-profiles*` (retired per SPEC-70; historical: `09-rundown-parser-profiles.md`) | Retired endpoints; intake parsing is governed by dynamic predefined field regex and song set regex | — | — | — | — |
