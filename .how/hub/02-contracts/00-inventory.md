...
| 96 | GET | `/api/admin/parser-profiles` | `09-rundown-parser-profiles.md` | retired |
| 97 | POST | `/api/admin/parser-profiles` | `09-rundown-parser-profiles.md` | retired |
| 93 | GET | `/api/admin/parser-profiles/[id]` | `09-rundown-parser-profiles.md` | retired |
| 94 | PATCH | `/api/admin/parser-profiles/[id]` | `09-rundown-parser-profiles.md` | retired |
| 95 | PUT | `/api/admin/parser-profiles/[id]` | `09-rundown-parser-profiles.md` | retired |
| 92 | DELETE | `/api/admin/parser-profiles/[id]` | `09-rundown-parser-profiles.md` | retired |
| 91 | POST | `/api/admin/parser-profiles/[id]/set-default` | `09-rundown-parser-profiles.md` | retired |
| 105 | GET | `/api/parser-profiles` | `09-rundown-parser-profiles.md` | retired |
