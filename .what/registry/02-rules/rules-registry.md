...
| BR-16 | Manual Device Sync refuses to Push to an instance while a presenter is actively projecting there — the sync lock (`TryAcquireSyncLock`) exists so a live service is never mutated mid-presentation. Pull carries no such guard. | registry | FR-40 · UC-32 | active |
