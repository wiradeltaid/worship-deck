...
- **오프라인 폰트 및 맞춤 서체:** 35개 패키지 번들 폰트를 내장하여 오프라인에서 즉시 사용 가능하며, ECMA-376 규격에 맞춘 커스텀 폰트 임베딩을 지원합니다.
...
- **서드파티 폰트 고지:** 35개 폰트 패밀리의 저작권 및 SIL OFL 1.1, Apache 2.0 라이선스 전문은 [THIRD-PARTY-NOTICES](THIRD-PARTY-NOTICES)에 수록되어 있습니다.
