...
- [x] Read `src/operator/CreateForm.tsx` and `src/operator/EditForm.tsx` in full first.
...
- [x] Verify both Create and Edit forms render cleanly and parse requests succeed without error.
