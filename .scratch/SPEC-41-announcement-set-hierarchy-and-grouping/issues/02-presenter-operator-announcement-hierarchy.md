...
- [x] Presenter Model (`src/operator/present/presenter-model.ts`):
...
- [x] Presenter Operator UI (`src/operator/present/PresenterOperator.tsx`):
...
- [x] Presenter Model Tests (`tests/presenter-model.test.mjs`):
