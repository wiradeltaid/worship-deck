...
- [ ] Category Reconciliation in Frontend (`src/components/admin/BackgroundLibraryPanel.tsx`):
...
- [ ] Upload Form Ergonomics & High-Contrast Visual State:
...
- [ ] Custom Name Display & Inline Rename:
...
- [ ] In-Place Image Replace Action on Gallery Cards:
