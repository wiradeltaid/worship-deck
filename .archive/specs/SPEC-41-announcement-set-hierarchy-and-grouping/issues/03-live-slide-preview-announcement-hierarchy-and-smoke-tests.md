...
- [x] Preview Model (`src/lib/artifacts/preview-model.ts`):
...
- [x] Live Slide Preview Component (`src/components/SlidePreviewList.tsx`):
...
- [x] Behavioral Tests & Absence Guards (`tests/smoke-spec-41.test.mjs`):
