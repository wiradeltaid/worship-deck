...
- [x] Extend server-side media library endpoints in `internal/httpapi/`:
...
- [x] Implement Media Gallery panel in `src/components/admin/`:
...
- [x] Integrate Gallery Picker into `ArtifactEditor.tsx`:
