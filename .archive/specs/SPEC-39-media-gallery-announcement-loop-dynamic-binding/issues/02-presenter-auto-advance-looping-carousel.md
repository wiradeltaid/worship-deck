...
- [x] Implement section-bounded looping state and timer controls in `src/operator/present/PresenterOperator.tsx`:
...
- [x] Synchronize loop advance to projection screen:
