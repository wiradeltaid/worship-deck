...
- [x] Author `tests/smoke-spec-45.test.mjs` testing:
...
- [x] Add `tests/smoke-spec-45.test.mjs` to `package.json`'s `test` script and create dedicated `smoke:spec-45` script.
- [x] Verify test suite passes cleanly under `node --test tests/smoke-spec-45.test.mjs`.
