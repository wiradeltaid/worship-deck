...
- **フォント管理とオフライン表示:** 35種類のローカル同梱フォントに加え、ECMA-376 規格に沿ったPowerPointフォント埋め込みに対応。
...
- **サードパーティフォント:** 35フォントファミリーの著作権情報および SIL OFL 1.1 / Apache 2.0 ライセンス全文は [THIRD-PARTY-NOTICES](THIRD-PARTY-NOTICES) に記載。
