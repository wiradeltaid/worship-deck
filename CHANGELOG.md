...
- **Canvas Slide Template Editor:** 38 editable slide templates in SQLite with full WYSIWYG canvas controls (drag, resize, text styling, undo/redo, and resets), plus PowerPoint-faithful text wrapping and 1:1 canvas-to-PPTX geometry parity.
